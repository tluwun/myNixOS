{
    wayland.windowManager.hyprland.settings = { 
        ...
        bindl = let ScreenShot = "~/Pictures/screenshot.png"; in [
            # Bind(s) for player
            ", F11, exec, playerctl play-pause"

            # Bind(s) for screenshots
            "$mainMod, X, exec, grim -g $(slurp) ${ScreenShot} && notify-send 'ScreenShot made in ${ScreenShot}'"
            ", Print, exec, grim -c ${ScreenShot}"
        ];
