{
    wayland.windowManager.hyprland.settings = { 
        ...
        bind = [
            ...
            "$mainMod CTRL, M, exec, cliphist list | rofi -dmenu | cliphist decode | wl-copy"
            "$mainMod, M, exec, $menu"
        ...
        bindl = [
            ...
            "$mainMod, X, exec, slurp | grim -g - ~/Картинки/screenshot.png && notify-send 'Скріншот зроблений в ~/Картинки/screenshot.png'"
            ", Print, exec, grim -c ~/Картинки/screenshot.png"
        ];
